...
timePassedMonths（0~12，**必填数字，时间的唯一来源**）：你返回多少，游戏时间就推进多少；返回 0 表示本回合不流逝。瞬时事件（说话/闲逛/思索）→ 0；数日 → 0.3；半月 → 0.5；一月 → 1；数月 → 2~6；半年 → 6；一年 → 12。不要无谓 +1。
...
3. 给出本回合流逝月数 timePassedMonths（0~12，**必填数字，时间的唯一来源**）：你返回多少，游戏时间就推进多少；返回 0 表示本回合不流逝（瞬时事件 0、数日 0.3、半月 0.5、一月 1、数月 2~6、半年 6、一年 12）。
